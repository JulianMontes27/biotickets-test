...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-zinc-800/50 relative overflow-hidden max-w-full">
      {/* Background Elements */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute top-10 left-10 sm:left-20 w-20 sm:w-24 h-20 sm:h-24 bg-[#FFD60A] rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-10 sm:right-32 w-24 sm:w-32 h-24 sm:h-32 bg-[#FFD60A] rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 w-12 sm:w-16 h-12 sm:h-16 bg-[#FFD60A] rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 relative z-10 max-w-full">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12">
          <div className="space-y-4 sm:space-y-6 sm:col-span-2 md:col-span-1">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div className="text-white/60 text-xs sm:text-sm font-mono tracking-[0.15em] sm:tracking-[0.2em] leading-relaxed">
                LIVE EXPERIENCES
              </div>
            </div>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <Link href="#" className="group p-2.5 sm:p-3 bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-full text-white/70 hover:text-[#FFD60A] hover:border-[#FFD60A]/40 transition-all duration-300">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 sm:gap-3">
              <Music className="text-[#FFD60A]" size={18} />
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 sm:gap-3">
              <Sparkles className="text-[#FFD60A]" size={18} />
          ...
          <div className="space-y-4 sm:space-y-6 sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3">
              <Mail className="text-[#FFD60A]" size={18} />
