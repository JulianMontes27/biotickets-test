          ...
          <div
            ...
            style={{
              transform: hoveredCard
                ? "translateY(-4px) rotateY(2deg)"
                : "translateY(0) rotateY(0deg)",
              boxShadow: hoveredCard
                ? "0 25px 50px rgba(99, 102, 241, 0.15), 0 10px 30px rgba(168, 85, 247, 0.1)"
                : "none",
              height: "480px",
            }}
          >
            ...
            <div
              className="p-4 bg-black/40 flex-1 flex flex-col justify-start min-h-0"
              style={{ height: "120px" }}
            >
