...
export default function EventsGridCard({ event }: EventsGridCardProps) {
  ...
  return (
    <Link href={href} target={linkTarget} rel={linkRel} className="block">
      <div
        ...
        style={{
          ...
          boxShadow: hoveredCard
            ? "0 20px 40px rgba(99, 102, 241, 0.1), 0 8px 24px rgba(168, 85, 247, 0.08)"
            : "none",
        ...
        {event.image && !imageError && (
          ...
          >
            <Image
              ...
              quality={30} // Reduced quality for grid view to save bandwidth
              placeholder="blur"
      ...
      {/* Card Content */}
      <div
        className="px-3 pb-3 pt-5 flex-1 flex flex-col justify-between"
        style={{ height: "110px" }}
      >
        {/* Title */}
